...
python "${script_path}tally.py" "${data_path}TAsite_info/TA_sites.txt" "${data_path}sample_data/${base_fna_name}.sam" "${data_path}genome_info/${gene_list_name}" "${data_path}genome_info/${fna_file}" > "${data_path}sample_data/${tally_output_name}"



###########Test original code#####################################
#test with brad's data & original scripts and files

#building Bowtie genome
bowtie-build /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/UCBPP-PA14.fasta /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/UCBPP-PA144

#begin running pipeline per sample
#mapping to genome, exact match
bowtie -v 0 -q -m 1 -S /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/UCBPP-PA144 \
       /idi/hunglabusers/jbagnall/klebs_tnseq/test/Test_set_P_aeruginosa/sample_data/M91_PA14.fastq.gz \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/sample_data/UCBPP-PA144.sam


python /home/unix/jbagnall/git/FiTnEss_JB/original/1_UNIX_genome-preprocessing_mapping/scripts/tally.py \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/TAsite_info/TA_sites.txt \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/sample_data/UCBPP-PA144.sam \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/genelist_PA14.txt \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/UCBPP-PA14.fasta > \
       /broad/hptmp/jbagnall/temp/PA14_M9_test_original_tally1.txt

#same using my new sam file
python /home/unix/jbagnall/git/FiTnEss_JB/original/1_UNIX_genome-preprocessing_mapping/scripts/tally.py \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/TAsite_info/TA_sites.txt \
       /idi/hunglabusers/jbagnall/klebs_tnseq/test/Test_set_P_aeruginosa/sample_data/GCA_000014625.1_ASM1462v1_genomic.sam \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/genelist_PA14.txt \
       /home/unix/jbagnall/git/FiTnEss_JB/original/Test_set_P_aeruginosa/genome_info/UCBPP-PA14.fasta > \
       /broad/hptmp/jbagnall/temp/PA14_M9_test_original_tally1.txt
